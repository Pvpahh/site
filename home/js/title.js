...
class Particle {
  constructor(canvas, progress) {
    ...
    this.color = random > .2 ? "#AB0426" : "#AB1B2E";
    this.radius = random > .8 ? Math.random() * 2 : this.radius;
    this.color = random > .8 ? "#81150E" : this.color;

    this.color  = random > .1 ? "#3d0905" : "#3d0905" // Alien
...
var x = 0;
var titleText = [ "S", "SL", "SLA", "SLAV", "SLAVE", "SLAVEZ", "SLAVEZ.", "SLAVEZ.S", "SLAVEZ.ST", "SLAVEZ.STO", "SLAVEZ.STOR", "SLAVEZ.STORE", "SLAVEZ.STOR", "SLAVEZ.STO", "SLAVEZ.ST", "SLAVEZ.S", "SLAVEZ.", "SLAVEZ", "SLAVE", "SLAVEZ", "SLAVE.", "SLAV", "SLA", "SL" "S" ];
